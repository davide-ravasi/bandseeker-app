...
export const ElementCard = ({ element }: ElementCardProps) => {
  ...
  return (
    <CardContainer>
      ...
      <GenresWrapper>
        {element.genres && <TagList tags={element.genres} />}
      </GenresWrapper>
      <Link
        href={{
          pathname: pagePath,
      ...
      {element.searching && <TagList title={'SEARCHING: '} tags={element.searching} />}

      {element.instruments && <TagList title={'INSTRUMENTS: '} tags={element.instruments} />}
