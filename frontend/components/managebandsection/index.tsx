...
export const ManageBandSection = () => {
  ...
  const { value: valueLocation, bind: bindLocation, reset: resetLocation } = useInput("");
  const { value: valueFoundation, bind: bindFoundation, reset: resetFoundation } = useInput("");
      ...
      <FormContainer>
        ...
        <form onSubmit={handleSubmit}>
          <InputContainer>
            ...
            <Input type="text" placeholder="Location" kind="input" {...bindLocation} />
            <Input type="text" placeholder="Foundation date" kind="input" {...bindFoundation} />
          </InputContainer>
          <ButtonContainer>
