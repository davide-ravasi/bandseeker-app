...
function loadSource(loader, resolveContext, source) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    document = parser_1.parse(source);
...
function loader(source) {
    return __awaiter(this, void 0, void 0, function () {
        var _this = this;
        var done, validationErrors, options, document, content, output, err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    this.cacheable();
                ...
                case 3:
                    ...
                    output = (options.output === "string" && options.minify) ? minifyDocumentString(content) : content;
